#!/usr/bin/env python3
# This model is a modified version of the SIR model from:
...
with open("./population.json", "rb") as f:
    compartments = load(f)
...
# TODO? SHOULD I OUTPUT TO CSV??? DOESN'T SEEM LIKE WE ARE USING IT AT THIS POINT


# PLOT IS UGLY BECAUSE `S` IS SO BIG AND I MESSED WITH THE COMPARTMENTS
